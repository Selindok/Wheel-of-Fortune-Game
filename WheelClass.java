...
public class WheelClass {
    ...
    private ArrayList<String> easyWheel = new ArrayList<String>();
    private ArrayList<String> mediumWheel = new ArrayList<String>();
    public ArrayList<String> hardWheel = new ArrayList<String>();
    public ArrayList<String> hardWheelAnswer = new ArrayList<String>();
    private ArrayList<String> braveWheel = new ArrayList<String>();
    ...
    WheelClass() {
        ...
        easyWheel.add("What it the last excuse you to stay with your friend?");
        ...
        easyWheel.add("Is there any whatsapp group that you have muted?");
        ...
        easyWheel.add("Tell me the most luxurious thing you’ll get when you’re rich.");
        ...
        mediumWheel.add("Did you meet through the ' dating app'?");
        ...
        mediumWheel.add(" What is your favorite CMPE_211 instructor ?");
        ...
        hardWheel.add("Single-digit maximum prime number difference ?");//4
